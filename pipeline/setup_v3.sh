...
essential_files=(
    "main_v3_corrected.nf"
    "nextflow_v3_corrected.config"
    "config/2022-12-07_CMC_TOPMed_updated_EUR.PGC.recipe"
...
run_v3_pipeline() {
    ...
    # Build command
    local cmd="nextflow run main_v3_corrected.nf"
...
show_v3_commands() {
    ...
    echo "   run_v3_pipeline                      # Full pipeline, all traits"
    echo "   run_v3_pipeline 'trait1,trait2' 'auto,1e-06'  # Specific traits/phi"
    echo ""
    echo "📊 MONITORING:"
    ...
    echo "   run_v3_pipeline '' '' -resume       # Resume from last checkpoint"
    echo ""
    echo "📁 KEY V3 OUTPUTS:"
...
# Export functions
export -f run_v3_pipeline
export -f run_v3_dev
export -f check_v3_status
export -f show_v3_commands

print_success "Created v3 helper functions: run_v3_pipeline, run_v3_dev, check_v3_status, show_v3_commands"
...
echo "- Clean and restart: nextflow clean -f && run_v3_pipeline"
echo ""
